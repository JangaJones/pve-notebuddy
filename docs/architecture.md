...
- `features/template-search-ui.js`
...
- Cross-feature event binding (form click/input delegation, add-row buttons, icon control listeners).
- Thin adapter helpers that route between features (radio/value bridges and `applyStateToRuntime`).
