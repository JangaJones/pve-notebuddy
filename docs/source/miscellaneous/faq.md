...
## How can I use exported `.jsons` from older versions?

The exported `.json` files from older versions of the app can be imported as [snapshots](../templates/snapshots) as of version 1.5.0, the templates should get updated to the newer schema automatically.
