...
export function getAppDomRefs() {
  ...
  return {
    ...
    templateManagerRefs: {
      ...
      localTemplateSearchClearEl: document.getElementById("localTemplateSearchClear"),
    ...
    sidebarRefs: {
      ...
      sidebarTabIconSearchEl: document.getElementById("sidebarTabIconSearch"),
      ...
      sidebarPanelIconSearchEl: document.getElementById("sidebarPanelIconSearch"),
    ...
    settingsRefs: {
      ...
      settingsIconSearchThumbnailsEl: document.getElementById("settingsIconSearchThumbnails"),
    ...
    iconSearchRefs: {
      ...
      iconSearchClearEl: document.getElementById("iconSearchClear"),
      iconSearchGridEl: document.getElementById("iconSearchGrid"),
    },
    iconRefs: {
